...
# Fixed IndentationError + bulk Excel import + photo OCR + admin edit/delete
...
# Add Reagent Tab - with bulk Excel import + single form + OCR
with tab2:
    ...
    if photo:
        ...
        with st.spinner("OCR..."):
            try:
                ...
                st.info("Copy info to the form above.")
            except Exception as e:
                st.error(f"OCR failed: {str(e)}")

# Other tabs (Log Usage, QR Tools, Admin) - add your existing code here
with tab3:
